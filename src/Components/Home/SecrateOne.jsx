        ...
        <div className='w-full '>
            ...
            <div className='flex flex-col   lg:flex-row justify-between items-center p-2 md:p-0 lg:ml-14  mt-10 gap-8'>
                <div className='text-secondary font-bold w-full lg:w-2/4'>
                      <h1 className='text-xl md:text-2xl lg:text-[30px] lg:p-2 mb-8  '>কিভাবে মাত্র ৩ দিনের ভিতর নিজের ব্যবসার জন্য একটি সেলিং মেশিন তৈরির যাবতীয় প্রস্তুতি নিবেন।</h1>
                      <ul className='lg:pl-2  space-y-5 md:text-xl lg:text-[20px]'>
                        <li className='flex justify-start  gap-3 '><FaShareSquare className='text-primary lg:w-8 w-5'/> আপনার ও আপনার সলিউশনের উপর কাস্টমারের বিশ্বাস তৈরি করুন</li>
                        ...
                        <li className='flex justify-start  gap-3'><FaShareSquare className='text-primary lg:w-8'/> আকর্ষণীয় ভাবে অফার উপস্থাপন করুন</li>
