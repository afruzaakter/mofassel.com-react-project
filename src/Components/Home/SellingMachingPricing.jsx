            ...
            {/* <RoundedDesign/> */}
                <div className="flex lg:flex-row gap-6 flex-col ">
                    <div className=" card  bg-white shadow-xl w-full p-5">
                        <h1 className="text-5xl text-gray-600 font-bold text-center"><span className="underline">Total Value:</span> ৳30000</h1>
                    </div>
                    <div className=" card  bg-white shadow-xl w-full p-5">
                        <h1 className="text-5xl text-gray-600 font-bold text-center"><span className="underline">Get It Today For Only </span> <span>৳1000</span></h1>
                    </div>
                </div>
                <h1 className="text-center text-primary text-[30px] font-bold mt-14 p-10 space-6">শুরু করবো কি করবো না? এমন চিন্তা আপনাকে পিছিয়ে দিবে, শুরু করুন, শিখুন, প্রয়োগ করুন, আমাদের সহযোগীতা নিন, অপটিমাইজেশন করুন, সেলস্‌ হবেই ইনশাআল্লাহ</h1>
            </div>  
        </div>
    );
};

export default SellingMachingPricing;